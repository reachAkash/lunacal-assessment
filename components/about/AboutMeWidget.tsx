...
//   return (
//     <div className="flex gap-5 bg-gray-400/20 rounded-3xl p-4 shadow-xl max-w-2xl">
...
//         <div
//           ref={containerRef}
//           className="relative w-[calc(100%-20px)] bg-[#171717] rounded-2xl px-1 py-1 mb-6 inline-flex gap-1"
//         >
//           <motion.div
//             className="absolute bg-white/20 rounded-2xl"
//             initial={false}
//             animate={{
...
//           {(["about", "experiences", "recommended"] as TabType[]).map((tab) => (
//             <TabButton
//               key={tab}
...
export default function AboutMeWidget() {
  ...
  return (
    <div className="flex gap-3 lg:gap-5 bg-gray-400/20 rounded-3xl p-3 sm:p-4 shadow-xl max-w-2xl">
      <div className="flex flex-col justify-between items-center h-full">
